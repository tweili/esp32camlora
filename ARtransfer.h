...
// Added:
uint32_t ARreceiveArrayNoACK(uint8_t *ptrarray, uint32_t length, uint32_t receivetimeout);
bool ARreceivePacketDTNoACK();
...
bool ARreceivePacketDTNoACK()
{
  ...
  ARRXPacketType = 0;
  ARRXPacketL = receiveDT(ARDTheader, HeaderSizeMax, (uint8_t *) ARDTdata, DataSizeMax, NetworkID, RXtimeoutmS, WAIT_RX);
